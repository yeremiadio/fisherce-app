...
const CustomButton = ({
  ...
  return (
    <View style={tw`mb-3 w-full`}>
      ...
      <View
        style={tw`${textFocusInputStyleBorder} transition-all rounded-lg py-[10px] px-4 bg-white text-base flex flex-row items-center`}
      >
        {icon ? icon : null}
        <TextInput
          ...
          onFocus={() =>
            setTextFocusInputStyleBorder("border border-blue-300")
          }
